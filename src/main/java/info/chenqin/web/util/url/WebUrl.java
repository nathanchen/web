package info.chenqin.web.util.url;
...
public final class WebUrl
{
    ...
    public static final String CONSOLE_WEATHER_PAGELET_URL = "console/weather";
    public static final String CONSOLE_CURRENCY_PAGELET_URL = "console/currency";
